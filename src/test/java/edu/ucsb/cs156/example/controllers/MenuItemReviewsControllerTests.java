...
public class MenuItemReviewsControllerTests extends ControllerTestCase {
  ...
  public void logged_in_user_can_get_all_menuitemreviews() throws Exception {
    ...
    MenuItemReview menuItemReview2 =
        MenuItemReview.builder()
            ...
            .stars(5)
            .dateReviewed(ldt2)
            .comments("can't stop thinking about it")
            .build();
  ...
  public void an_admin_user_can_post_a_new_menuitemreview() throws Exception {
    ...
    MvcResult response =
        mockMvc
            .perform(
                post("/api/menuitemreviews/post?itemId=1&reviewerEmail=julia_lin@ucsb.edu&stars=2&dateReviewed=2022-01-03T00:00:00&comments=food")
                    .with(csrf()))
