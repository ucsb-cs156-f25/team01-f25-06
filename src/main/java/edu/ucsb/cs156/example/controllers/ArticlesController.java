...
public class ArticlesController extends ApiController {
   ...
   * @param explanation the article's use and contentes
   * @param email the email address of who submitted the article
   * @param dateAdded the date of when the article was submitted to the table
