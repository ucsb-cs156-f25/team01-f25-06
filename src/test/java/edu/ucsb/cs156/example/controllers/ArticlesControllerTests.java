...
public class ArticlesControllerTests extends ControllerTestCase {
  ...
  public void logged_in_user_can_get_all_articles() throws Exception {
    ...
    // arrange
    LocalDateTime ldt1 = LocalDateTime.parse("2025-10-25T00:00:00");

    Articles article1 =
        Articles.builder()
            .title("CS156 Canvas")
            .url("https://ucsb.instructure.com/courses/27687")
            .explanation("Testing logged_in_user_can_get_all_ucsbdates()")
  ...
  public void an_admin_user_can_post_a_new_article() throws Exception {
    ...
    MvcResult response =
        mockMvc
            .perform(
                post("/api/articles/post?title=CS156Canvas&url=https://ucsb.instructure.com/courses/27687&explanation=Testing&email=natalieforte@ucsb.edu&dateAdded=2025-10-25T00:00:00")
                    .with(csrf()))
  ...
  //   verify(ucsbDateRepository, times(1)).save(ucsbDateEdited); // should be saved with correct
  // user
  //   String responseString = response.getResponse().getContentAsString();
